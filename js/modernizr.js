...
window.Modernizr = (function( window, document, undefined ) {
  ...
  function closeOverlay() {
    ...
    document.getElementById("image.zoom").onclick = function() {
      if (this.style.width === "100px") {
          this.style.width = "500px";  // Change to the desired enlarged size
      } else {
          this.style.width = "100px";  // Change back to the smaller size
      }
  };
  // Get the modal
